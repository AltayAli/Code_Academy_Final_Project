...
namespace MozambikMVC.Migrations
{
    ...
    [Migration("20200214104615_NewTables2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MozambikMVC.Data.Entities.Category", b =>
                {
                    b.HasOne("MozambikMVC.Data.Entities.SubMenu", null)
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("MozambikMVC.Data.Entities.Marka", b =>
                {
                    b.HasOne("MozambikMVC.Data.Entities.Category", null)
                        .WithMany("Markas")
            ...
            modelBuilder.Entity("MozambikMVC.Data.Entities.Product", b =>
                {
                    b.HasOne("MozambikMVC.Data.Entities.Item", "Item")
                        .WithOne("Product")
                        .HasForeignKey("MozambikMVC.Data.Entities.Product", "ItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MozambikMVC.Data.Entities.Model", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("MozambikMVC.Data.Entities.SubMenu", b =>
                {
                    b.HasOne("MozambikMVC.Data.Entities.Menu", null)
                        .WithMany("SubMenus")
